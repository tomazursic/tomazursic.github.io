...
Typing a letter here doesn't insert text, but rather lets you navigate and manipulate text in various ways.
...
This is where you actually insert text.
You can type i to get into insert mode.
Keep in mind that while the commands below are handy, Vim works best when you stay out of insert mode as much as possible. In other words, go into insert mode only to enter text, and get back into normal mode as soon as possible.
...
**Vim User Disorder** syndrom: The vim editor which is always in use,
so much that you start smashing into alien editors with vim commands.
